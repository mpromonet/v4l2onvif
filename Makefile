...
SERVER_OBJ=gen/soapDeviceBindingService.o 
...
CLIENT_OBJ=gen/soapDeviceBindingProxy.o
...
gen/onvif.h: devicemgmt.wsdl media.wsdl recording.wsdl replay.wsdl receiver.wsdl search.wsdl event.wsdl imaging.wsdl display.wsdl onvif.xsd b-2.xsd include bf-2.xsd t-1.xsd 
...
server.exe: $(SOAP_OBJ) $(SERVER_OBJ) serverDevice.o serverMedia.o serverRecording.o serverReplay.o serverEvent.o serverPullPointSubscription.o serverReceiver.o  serverImaging.o serverSearch.o serverDisplay.o server.o onvif_impl.o $(WSSE_SRC)
