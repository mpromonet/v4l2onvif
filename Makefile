...
gen/onvif.h: 
	$(GSOAP_PREFIX)/bin/wsdl2h -Ntev -z6 devicemgmt.wsdl media.wsdl recording.wsdl replay.wsdl receiver.wsdl event.wsdl onvif.xsd b-2.xsd include bf-2.xsd t-1.xsd bw-2.wsdl -o $@.tmp 
	echo '#import "wsse.h"' > $@
	cat $@.tmp >> $@

gen/soapDeviceBindingService.cpp: gen/onvif.h
	$(GSOAP_PREFIX)/bin/soapcpp2 -2jx $^ -I $(GSOAP_IMPORT) -d gen -f500 

server.exe: $(SOAP_OBJ) gen/soapDeviceBindingService.o serverDevice.o gen/soapMediaBindingService.o serverMedia.o gen/soapRecordingBindingService.o serverRecording.o gen/soapReplayBindingService.o serverReplay.o gen/soapEventBindingService.o serverEvent.o gen/soapPullPointSubscriptionBindingService.o serverPullPointSubscription.o gen/soapReceiverBindingService.o serverReceiver.o $(GSOAP_WSSE) server.o   
	$(CXX) -g -o $@ $^ $(GSOAP_LDFLAGS) $(GSOAP_CFLAGS)

client.exe: $(SOAP_OBJ) gen/soapDeviceBindingProxy.o gen/soapMediaBindingProxy.o gen/soapRecordingBindingProxy.o gen/soapReplayBindingProxy.o gen/soapEventBindingProxy.o gen/soapPullPointSubscriptionBindingProxy.o gen/soapReceiverBindingProxy.o $(GSOAP_WSSE) client.o 
	$(CXX) -g -o $@ $^ $(GSOAP_LDFLAGS) $(GSOAP_CFLAGS)
